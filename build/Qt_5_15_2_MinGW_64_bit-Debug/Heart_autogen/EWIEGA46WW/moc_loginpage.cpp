...
QT_MOC_LITERAL(1, 10, 10), // "checkLogin"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 16), // "DatabaseManager&"
QT_MOC_LITERAL(4, 39, 2), // "db"
QT_MOC_LITERAL(5, 42, 13), // "checkRegister"
QT_MOC_LITERAL(6, 56, 11), // "checkCancel"
QT_MOC_LITERAL(7, 68, 12), // "openSettings"
QT_MOC_LITERAL(8, 81, 9) // "closePage"

    },
    "LoginPage\0checkLogin\0\0DatabaseManager&\0"
    "db\0checkRegister\0checkCancel\0openSettings\0"
    "closePage"
};
...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->checkLogin((*reinterpret_cast< DatabaseManager(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: { bool _r = _t->checkRegister((*reinterpret_cast< DatabaseManager(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 2: { bool _r = _t->checkCancel((*reinterpret_cast< DatabaseManager(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
