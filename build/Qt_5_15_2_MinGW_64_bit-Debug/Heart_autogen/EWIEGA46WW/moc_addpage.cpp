...
struct qt_meta_stringdata_AddPage_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AddPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddPage_t qt_meta_stringdata_AddPage = {
    {
QT_MOC_LITERAL(0, 0, 7) // "AddPage"
...
QT_INIT_METAOBJECT const QMetaObject AddPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_AddPage.data,
    qt_meta_data_AddPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AddPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddPage.stringdata0))
